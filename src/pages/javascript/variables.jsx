...
const JSVariablesPage = () => {
  return (
    ...
    >
      ...
      <CodeSnippet
        content={varSnippet}
        codeContainerStyle={{ marginRight: "0.5rem", marginLeft: "0.5rem" }}
      />
      ...
      <CodeSnippet
        content={varHoistedSnippet}
        codeContainerStyle={{ marginRight: "2rem", marginLeft: "2rem" }}
      />
