...
const CSSSettingUpPage: NextPage = () => {
  return (
    <Layout
      sidebar={true}
      hideAd={true}
      ...
      seo={seo}
    >
      <Heading content="Setting up" headingType="h1" customStyle={tw`mb-4`} />
      ...
      <Heading content="Inline CSS with a style attribute:" headingType="h4" customStyle={tw`mt-8`} />
