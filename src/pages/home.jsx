...
export default function Home() {
  ...
  return (
    <>
      <header>
        <nav
          className="relative flex w-full items-center justify-between bg-white py-2 text-neutral-600 shadow-lg hover:text-orange-500 focus:text-orange-700 dark:bg-neutral-500 dark:text-orange-600 md:flex-wrap md:justify-start"
          data-te-navbar-ref
        >
        ...
        <div className="bg-neutral-50 px-6 py-20 text-center text-neutral-800 dark:bg-neutral-700 dark:text-neutral-200">
          <h1 className="mb-6 text-5xl font-bold">HOME</h1>
          <h3 className="mb-8 text-3xl font-bold">HOME</h3>
        </div>
      </header>
